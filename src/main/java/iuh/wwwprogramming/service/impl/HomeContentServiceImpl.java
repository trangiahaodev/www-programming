...
public class HomeContentServiceImpl implements HomeContentService {
    ...
    private final iuh.wwwprogramming.repository.OfficeRepository officeRepository;

    @Override
    public List<OfficeDTO> getOffices() {
        var dbOffices = officeRepository.findByActiveTrue();
        if (dbOffices != null && !dbOffices.isEmpty()) {
            return dbOffices.stream().map(o -> OfficeDTO.builder()
                    .id(o.getId())
                    .title(o.getTitle())
                    ...
                    .supportType(o.getSupportType())
                    .coupon(o.getCoupon())
                    .perks(o.getPerks() != null ? new ArrayList<>(o.getPerks()) : List.of())
                    .image(o.getImage())
                    .build()
